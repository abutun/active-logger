...
namespace ActiveLogger
{
    ...
    public class Service
    {
        ...
        /// </remarks>
        public Service(bool InstallMouseHook, bool InstallKeyboardHook)
        {
        ...
        /// <summary>
        /// Declare service status as ServiceStatus enum
        /// </summary>
        private Enums.ServiceStatus serviceStatus = Enums.ServiceStatus.STOPPED;
        ...
        public void Start(bool InstallMouseHook, bool InstallKeyboardHook)
        {
            ...
            this.serviceStatus = Enums.ServiceStatus.STARTED;
        }
        ...
        public void Stop(bool UninstallMouseHook, bool UninstallKeyboardHook, bool ThrowExceptions)
        {
            ...
            this.serviceStatus = Enums.ServiceStatus.STOPPED;
        }
        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            ...
            if ((nCode >= 0) && (KeyDown != null || KeyUp != null || KeyPress != null))
            {
                ...
                if (KeyPress != null && wParam == WM_KEYDOWN)
                {
                    ...
                    if (ToUnicodeEx((uint)MyKeyboardHookStruct.vkCode,
        ...
        public Enums.ServiceStatus ServiceStatus
        {
            get
            {
